...
export const Investments: FC<{}> = ({ }) => {
  ...
  return <>
    <div className="Investments">
      <UserInversion setInvestments={setInvestments} investments={investments} coinList={coinList} />
      <GeneralBalance coinList={coinList} investments={investments} coinsDatails={coinsDatails} />
    </div>
  </>
}